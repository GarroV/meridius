 ...
 * не доставало и остального: без шрифтов текст набирался системным, а без атрибута темы
 * тёмная настройка телефона не доезжала. Шрифты здесь берутся оттуда же, откуда весь
 * продукт, — из `globals.css`, который несёт ядро дизайн-системы вместе с его файлами
 * начертаний. Импорт стоит именно в этом файле, а не подразумевается из корневой
 * разметки: она в этом сценарии и упала.
 *
